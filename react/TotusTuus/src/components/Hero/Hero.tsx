...
function Hero() {
    ...
    return (
                ...
                <div className="hero-content" data-aos="fade-up">
                    ...
                    <div className="countdown">
                        <div className="countdown-item">
                            <div id="days" className="countdown-number">{days}</div>
                            <div className="countdown-label">Dias</div>
                        </div>
                        <div className="countdown-item">
                            <div id="hours" className="countdown-number">{hours}</div>
                            <div className="countdown-label">Horas</div>
                        </div>
                        <div className="countdown-item">
                            <div id="minutes" className="countdown-number">{minutes}</div>
                            <div className="countdown-label">Minutos</div>
                        </div>
                        <div className="countdown-item">
                            <div id="seconds" className="countdown-number">{seconds}</div>
        ...
        {/* Reveal Section (Hidden until countdown ends) */}
        <div id="reveal-section" className="reveal-section">
